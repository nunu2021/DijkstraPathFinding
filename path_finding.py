...
# Make some Buttons
dijkstraButton = Button(GREY, 0, SCREEN_WIDTH, SCREEN_WIDTH / 3, BUTTON_HEIGHT,
...
recursiveMazeButton = Button(GREY, (SCREEN_WIDTH / 3) * 2, SCREEN_WIDTH + BUTTON_HEIGHT, SCREEN_WIDTH / 3,
                             BUTTON_HEIGHT, "Maze (recursive div)")
terrainButton = Button(GREY, (SCREEN_WIDTH / 3) * 2, SCREEN_WIDTH + BUTTON_HEIGHT * 2, SCREEN_WIDTH / 3, BUTTON_HEIGHT,
                       "Random Terrain")
visToggleButton = Button(GREY, SCREEN_WIDTH / 3, SCREEN_WIDTH + BUTTON_HEIGHT * 2, SCREEN_WIDTH / 3, BUTTON_HEIGHT,
...
while not done:
    ...
    def update_gui(draw_background=True, draw_buttons=True, draw_grid=True):
        ...
        if draw_buttons:
            visToggleButton = Button(GREY, SCREEN_WIDTH / 3, SCREEN_WIDTH + BUTTON_HEIGHT * 2, SCREEN_WIDTH / 3,
